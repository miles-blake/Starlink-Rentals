        ...
        <div className="flex w-full max-w-2xl flex-col gap-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2 text-sm leading-relaxed">
              ...
              for the operator&apos;s own review — not a substitute for
          ...
          <Section title="What we collect">
            <ul className="list-disc space-y-1 pl-5">
              <li>
                Your name, email, and phone number, given when you book.
              </li>
              <li>
                Your delivery or pickup address, resolved and validated
                through the Google Maps Platform.
              </li>
              <li>
              ...
              <li>
                Your electronic signature on the Rental Agreement — typed
                name, timestamp, IP address, and browser — as required for it
                to be legally binding.
              </li>
              <li>
                Photos of the equipment&apos;s condition at drop-off and
                return, taken by the operator.
              </li>
            </ul>
          </Section>
          ...
          <Section title="What we use it for">
            ...
            refund, sending status and reminder emails, and resolving any
          ...
          <Section title="Who we share it with">
            ...
            storage for photos and signed agreements). We don&apos;t sell
            your information or share it for advertising.
          </Section>

          <Section title="How long we keep it">
            Reservation records, signed agreements, and condition photos are
            kept for our own recordkeeping and in case of a dispute. Contact
            us if you&apos;d like your information removed once your rental
